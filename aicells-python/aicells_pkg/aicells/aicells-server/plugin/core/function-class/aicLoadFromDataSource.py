...
class aicLoadFromDataSource(AICFunction):
    def Run(self, arguments):
        a = self.ProcessArguments(arguments, 'parameters')

        return UDFUtils.ReturnDataFrame(a['data_source'], columnHeader=a['display_column_headers'], rowHeader=a['display_row_headers'],
